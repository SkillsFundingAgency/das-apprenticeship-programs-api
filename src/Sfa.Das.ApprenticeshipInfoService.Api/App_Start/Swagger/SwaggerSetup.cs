    ...
    public static class SwaggerSetup
    {
        public static void Configure(HttpConfiguration config)
        {
            ...
            config.EnableSwagger("swagger/docs/{apiVersion}", c =>
            {
                ...
                //c.SingleApiVersion("v1", "Apprenticeship Programmes API");
                ...
                c.MultipleApiVersions(
                            ...
                            info =>
                            {
                                ...
                                {
                                    var description = "Provides details about apprenticeship programmes, training providers and assessment organisations.";
                                    ...
                                    info.Version(group.Name, $"Apprenticeship Programmes API")
        ...
        {
            return string.Format(@"{0}\bin\Sfa.Das.ApprenticeshipInfoService.Api.XML",
