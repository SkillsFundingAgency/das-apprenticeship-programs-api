...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Other", "    Get ALL the Other", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.TestCaseAttribute("apprenticeship-programmes", "OK", null)]
        [NUnit.Framework.TestCaseAttribute("health", "OK", null)]
...
this.ScenarioSetup(scenarioInfo);
#line 15
 testRunner.Given("I send request to apprenticeship-programmes", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line 16
 testRunner.Then("I expect the amount of refult will be at least 800", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            this.ScenarioCleanup();
        }
    }
